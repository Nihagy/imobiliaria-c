...
void CadastroCliente()
	{	
		...
		cadastro= fopen("CadastroCliente.txt","a++");// verificar se aqui eu abro usando o W  e depois vou usando A para adicionar.
...
void lerCadastroCliente()
	{
	  ...
	  Leitura = fopen("CadastroCliente.txt", "r");
...
void CadastroCorretor()
	{
		...
		cadastro= fopen("CadastroCorretor.txt","a++");// verificar se aqui eu abro usando o W  e depois vou usando A para adicionar.

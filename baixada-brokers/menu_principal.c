/*
    versão 2.0 Programa Imobilaria
...
void MenuAjuda(Console){
    ...
    switch(opcao){
        ...
        case '8': // ajuda
            system("cls");
            SetConsoleTextAttribute(Console, BRANCO);
            printf( "\n\n\t\tO Menu Ajuda, Esse mesmo que você esta"
...
//Redireciona para qual menu vai acessar de acordo com as opcão e todos retornam para o menu
int menu(Console){
